...
local function createKeyGUI()
    ...
    title.Text = "Blade Ball Key System"
    ...
    check.Size = UDim2.new(0.35,0,0,30)
    check.Position = UDim2.new(0.1,0,0.7,0)
    check.Text = "Check"

    local get = Instance.new("TextButton", frame)
    get.Size = UDim2.new(0.35,0,0,30)
    get.Position = UDim2.new(0.55,0,0.7,0)
    get.Text = "Get Key"
...
createKeyGUI()
repeat task.wait() until not game.CoreGui:FindFirstChildOfClass("ScreenGui")
