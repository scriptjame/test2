...
get.Position = UDim2.new(0.1,0,0.65,0)
get.Text = "Get Key"
...
verify.Position = UDim2.new(0.5,0,0.65,0)
verify.Text = "Verify Key"
verify.BackgroundColor3 = Color3.fromRGB(60,80,255)
...
get.MouseButton1Click:Connect(function()
    ...
    game.StarterGui:SetCore("SendNotification",{
        Title = "Key System",
        Text = "Lootlink copied to clipboard",
        Duration = 5
    })
...
verify.MouseButton1Click:Connect(function()
    ...
    if box.Text:gsub("%s+","") == correctKey then
